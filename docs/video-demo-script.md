...
| 4:45-5:00 | README Grader's 5-minute path or `docs/submission-google-doc-draft.md` | "The proof path is now explicit: shipped surfaces, honest dev eval, local UI walkthrough, and the live Space limitation. Skill-Gap Diagnosis is available as a CLI/core pull-in; memory and mock interview stay on the roadmap." |
